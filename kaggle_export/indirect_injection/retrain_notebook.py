"""
Kaggle retrain script — indirect_injection detector v4
Run on Kaggle GPU (T4 or P100): Settings > Accelerator > GPU

Dataset input: adversarial-guardrail-indirect-injection-r1 (attach in Kaggle notebook)
Output: fine-tuned DistilBERT model pushed to HF Hub as Builder117/distilbert-indirect-injection-v4
"""
import os
import pandas as pd
...
MODEL_OUT = "Builder117/distilbert-indirect-injection-v4"
DATASET_CSV = "/kaggle/input/adversarial-guardrail-indirect-injection-r1/dataset.csv"
BASE_MODEL = "distilbert-base-uncased"
LABEL2ID = {"INDIRECT": 1, "LEGIT": 0}
ID2LABEL = {1: "INDIRECT", 0: "LEGIT"}
